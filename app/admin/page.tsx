...
const QUICK_LINKS = [
  ...
  {
    title: "Insights",
    description: "Customer health, brand share, rising/falling SKUs, and price distribution.",
    href: "/admin/insights",
    emoji: "💡",
  },
  {
    title: "Market by city",
    description: "Miami, Orlando, Melbourne, Jacksonville — growth by period and per account.",
    href: "/admin/market",
    emoji: "🌴",
  },
  {
    title: "Top SKUs",
    description: "Rank best sellers, then drill into which accounts buy each SKU.",
    href: "/admin/top-skus",
    emoji: "📊",
  },
  {
